...
#define _0000_TAU_COMBINATION_SLAVE		0x0000U	/* operates as slave channel with combination operation function */  
...
#define _0001_TAU_CH0_START_TRG_ON		0x0001U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 1 (TSm1) */
#define _0000_TAU_CH1_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0002_TAU_CH1_START_TRG_ON		0x0002U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 2 (TSm2) */
#define _0000_TAU_CH2_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0004_TAU_CH2_START_TRG_ON		0x0004U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 3 (TSm3) */
#define _0000_TAU_CH3_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0008_TAU_CH3_START_TRG_ON		0x0008U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 4 (TSm4) */
#define _0000_TAU_CH4_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0010_TAU_CH4_START_TRG_ON		0x0010U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 5 (TSm5) */
#define _0000_TAU_CH5_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0020_TAU_CH5_START_TRG_ON		0x0020U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 6 (TSm6) */
#define _0000_TAU_CH6_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0040_TAU_CH6_START_TRG_ON		0x0040U	/* operation is enabled (start software trigger is generated) */
/* Operation enable (start) trigger of channel 7 (TSm7) */
#define _0000_TAU_CH7_START_TRG_OFF		0x0000U	/* no trigger operation */
#define _0080_TAU_CH7_START_TRG_ON		0x0080U	/* operation is enabled (start software trigger is generated) */
...
#define _0200_TAU_CH1_H8_START_TRG_ON		0x0200U	/* operation is enabled (start software trigger is generated) */
...
#define _0800_TAU_CH3_H8_START_TRG_ON		0x0800U	/* operation is enabled (start software trigger is generated) */
...
#define _0001_TAU_CH0_OUTPUT_ENABLE		0x0001U	/* the TOm0 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH0_OUTPUT_DISABLE		0x0000U	/* the TOm0 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 1 (TOEm1) */
#define _0002_TAU_CH1_OUTPUT_ENABLE		0x0002U	/* the TOm1 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH1_OUTPUT_DISABLE		0x0000U	/* the TOm1 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 2 (TOEm2) */
#define _0004_TAU_CH2_OUTPUT_ENABLE		0x0004U	/* the TOm2 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH2_OUTPUT_DISABLE		0x0000U	/* the TOm2 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 3 (TOEm3) */
#define _0008_TAU_CH3_OUTPUT_ENABLE		0x0008U	/* the TOm3 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH3_OUTPUT_DISABLE		0x0000U	/* the TOm3 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 4 (TOEm4) */
#define _0010_TAU_CH4_OUTPUT_ENABLE		0x0010U	/* the TOm4 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH4_OUTPUT_DISABLE		0x0000U	/* the TOm4 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 5 (TOEm5) */
#define _0020_TAU_CH5_OUTPUT_ENABLE		0x0020U	/* the TOm5 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH5_OUTPUT_DISABLE		0x0000U	/* the TOm5 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 6 (TOEm6) */
#define _0040_TAU_CH6_OUTPUT_ENABLE		0x0040U	/* the TOm6 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH6_OUTPUT_DISABLE		0x0000U	/* the TOm6 operation stopped by count operation (timer channel output bit) */
/* Timer output enable/disable of channel 7 (TOEm7) */
#define _0080_TAU_CH7_OUTPUT_ENABLE		0x0080U	/* the TOm7 operation enabled by count operation (timer channel output bit) */
#define _0000_TAU_CH7_OUTPUT_DISABLE		0x0000U	/* the TOm7 operation stopped by count operation (timer channel output bit) */
...
#define _473F_TAU_TDR00_VALUE			0x473FU
