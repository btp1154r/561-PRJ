...
#define	_80_CGC_SUBINHALT_OFF		0x80U	/* stops supply of subsystem clock to peripheral functions other than real-time counter and interval timer */
...
#define	_00_CGC_ILLEGAL_MEMO_ACCESS_OFF	0x00U	/* disables illegal memory access detection */
#define	_80_CGC_ILLEGAL_MEMO_ACCESS_ON	0x80U	/* enables illegal memory access detection */
...
#define	_02_CGC_INT_GUARD_ON		0x02U	/* valid, it is impossible to write interrupt register, but possible for read*/
